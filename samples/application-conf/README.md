...
See the [language configuration mapping documentation](FilePropertyManagement.md#language-configuration-mapping) for more details on how to enable and use language configuration mapping.
