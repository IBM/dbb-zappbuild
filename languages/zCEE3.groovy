...
sortedList.each { buildFile ->
    ...
    boolean alwaysRebuildWAR = (props.getFileProperty('zcee3_alwaysRebuildWAR', buildFile) == null) ? true : props.getFileProperty('zcee3_alwaysRebuildWAR', buildFile).toBoolean()
    ...
    if (alwaysRebuildWAR || !WarFile.exists()) {
        println("** The 'api.war' file was not found for this z/OS Connect project or the rebuild was forced. Building it...")
        ...
        println("** The 'api.war' file was found for this z/OS Connect project and will be reported in the Build Report.")
    }
